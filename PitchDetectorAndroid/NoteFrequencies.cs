...
namespace PitchDetectorAndroid
{
    public struct Note
    {
        ...
        public static implicit operator Note ((string, double) s)
        {
            return new Note(s.Item1, s.Item2);
        }

        public static implicit operator KeyValuePair<string, double>(Note n)
        {
            return new KeyValuePair<string, double>(n.Name, n.Frequency);
        }

        public static implicit operator Note(KeyValuePair<string, double>  s)
        {
